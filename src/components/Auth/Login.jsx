...
import img from '../../assets/images/news-logo.png';
...
function Login(props) {
  ...
  return (
    ...
    {/* <div className="flex items-center justify-center h-screen bg-black">
      <div className="w-1/3 bg-white rounded-lg p-8 m-4">
        <div className='flex justify-center mb-2'><img src={img} alt="" className="w-20 h-20 bg-white" /></div>
    ...
    <div className="flex items-center justify-center h-screen bg-gradient-to-r from-blue-800 to-white">
        <div className="min-w-fit w-1/3 flex-col border bg-white px-6 py-14 shadow-md rounded-xl">
          <div className="mb-8 flex justify-center">
            <img className="w-24" src={img} alt="" />
          </div>
          <form onSubmit={handleSubmit} className="space-y-4 px-4">
          <div className="flex flex-col text-sm rounded-md">
            <input className="mb-5 rounded-[4px] border p-3 hover:outline-none focus:outline-none hover:border-yellow-500 " type="text"
              id="username"
              value={username}
              onChange={handleUsernameChange}
              placeholder="Username or Email id" />
            <input className="border rounded-[4px] p-3 hover:outline-none focus:outline-none hover:border-yellow-500"  type="password"
              id="password"
              value={password}
              onChange={handlePasswordChange} 
